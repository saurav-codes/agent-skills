...
| [ai-company-with-tmux](https://github.com/saurav-codes/ai-company-with-tmux) | Runs a hierarchical AI agent company over tmux agent panes: a tech lead hands off to senior engineer panes that execute with workers and a strongest-model reviewer, communicating via handoff and inbox files | `npx skills add saurav-codes/ai-company-with-tmux -g` |
